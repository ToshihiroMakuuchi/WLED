...
M5Stack CoreS3 上で WLED v17 系をネイティブ動作させ、  
...
<p align="center">
  <img src="docs/screenshots/main.png" width="320">
</p>
...
<table>
  <tr>
    <td><img src="docs/screenshots/effect-solid.png" width="320"></td>
    <td><img src="docs/screenshots/effect-rocktaves.png" width="320"></td>
  </tr>
  <tr>
...
<table>
  <tr>
    <td><img src="docs/screenshots/color-c1.png" width="320"></td>
    <td><img src="docs/screenshots/color-c1-c2.png" width="320"></td>
    <td><img src="docs/screenshots/color-unused.png" width="320"></td>
  </tr>
  <tr>
...
<table>
  <tr>
    <td><img src="docs/screenshots/preset.png" width="320"></td>
    <td><img src="docs/screenshots/preset-manage.png" width="320"></td>
    <td><img src="docs/screenshots/preset-save.png" width="320"></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><img src="docs/screenshots/preset-delete.png" width="320"></td>
    <td><img src="docs/screenshots/preset-boot.png" width="320"></td>
    <td></td>
  </tr>
  <tr>
...
BMP は CoreS3 の LCD から RGB565 で読み出し、24-bit BMP に変換して返します。  
大きな Screenshot バッファは通常時には常駐せず、要求時のみ PSRAM に確保します。

README に掲載している PNG 画像も、この Browser Screenshot で取得した BMP を PC 側で PNG に変換したものです。
...
これは WLED 本体のデフォルト値を変更するものではありません。  
