...
This project runs the WLED v17 series natively on M5Stack CoreS3 and combines  
...
The endpoint returns a still image.  
Refreshing the URL captures the current 320 × 240 LCD contents again.

The LCD is read as RGB565 and converted to a 24-bit BMP.  
...
This does not modify the WLED core default.  
...
> This does not claim that DCDC3 itself was proven to be the sole hardware root cause.  
...
- Segment management is intentionally not implemented in the local UI.  
